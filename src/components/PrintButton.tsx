...
export default function PrintButton({ title, content, date, location }: PrintButtonProps) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center px-4 py-2 bg-customButton text-white rounded-lg hover:bg-red-700 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
    >
      {isGenerating ? (
        <>
