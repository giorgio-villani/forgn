...
FORGN's teaching artist residency empowers creatives to build sustainable income and brands through co-created, scalable workshops like Digital Art 101, Sculpture, Blender, Pottery, Painting, and Creative Writing. Residents partner with FORGN, splitting class profits to incentivize growth over hourly wages. They develop skills in curriculum design (structuring multi-week or modular classes), public speaking (leading for diverse learners), and translating studio practices into accessible lessons (e.g., printmaking, creative coding, generative AI). Training includes educational product development—pricing and positioning co-branded courses—and community-responsive teaching to create engaging, inclusive experiences. Supported by FORGN's media promotion and pedagogy training, residents inspire entrepreneurs and hobbyists to craft community-focused projects, like immersive event environments, reaching students and enriching Houston's creative education landscape.
